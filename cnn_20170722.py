...
def form_extract(paper):
	...
	form = four_point_transform(paper, screenCnt.reshape(4, 2))
...
def cell_extract(form):
	...
	blur = cv2.GaussianBlur(form, (5, 5), 0)
...
# Loading image files
src_path = '/home/billy73480/Handwriting_Recognition/Paper/'
